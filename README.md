Note: This repo is not being actively developed, and is currently looking for maintainers: https://github.com/jquery-backstretch/jquery-backstretch/issues/464
...
|------|-------------|------|---------|
| `centeredX` (Deprecate) | The ratio of the width/height of the image doesn't always jive with the width/height of the window. This parameter controls whether or not we center the image on the X axis to account for the discrepancy. | Boolean | true |
| `centeredY` (Deprecate) | This parameter controls whether or not we center the image on the Y axis to account for the aforementioned discrepancy. | Boolean | true |
...
| `alignX` | This parameter controls the image align on the X axis. Values: center, left or right. | String | center |
| `alignY` | This parameter controls the image align on the Y axis. Values: center, top or bottom. | String | center |
