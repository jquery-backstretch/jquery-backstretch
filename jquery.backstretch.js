...
;(function ($, window, undefined) {
    ...
    $.fn.backstretch.defaults = {
        ...
        , minWidth:-1      // The minimum image size to scale to
        , minHeight:-1     // The minimum image size to scale to
    ...
    Backstretch.prototype = {
        resize:function () {
            try {
                ...
                if (rootWidth < this.options.minWidth || rootHeight < this.options.minHeight) {
                    rootWidth = this.options.minWidth;
                    rootHeight = this.options.minHeight;
                }
