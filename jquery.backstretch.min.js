;(function($,window,undefined){'use strict';$.fn.backstretch=function(images,options){if(images===undefined&&this.css('backgroundImage')){images=[this.css('backgroundImage').replace(/url\(|\)|"|'/g,"")];}
