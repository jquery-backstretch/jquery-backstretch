;(function($,window,undefined){'use strict';$.fn.backstretch=function(images,options){console.log(this.css('backgroundImage'));if(images===undefined&&this.css('backgroundImage')){images=[this.css('backgroundImage').replace(/url\(|\)|"|'/g,"")];}
if(images===undefined||images.length===0){$.error("No images were supplied for Backstretch");}
